    ...
    return (
        <>
            ...
            <div className='flex flex-center mt-[3rem] flex-wrap md:justify-evenly  '>
                <div className='flex flex-wrap justify-center  md:max-w-[50%] md:p-5 md:justify-center  md:ml-[3rem] gap-5 rounded-full '>
                    ...
                    <img src="./react.png" alt="react image" className='rounded-full w-[13rem]' />
                    <img src="./tailwind.png" alt="tailwind image" className='rounded-full  w-[11rem]' />
                </div>
                <div className='text-center '>
                    <h2 className='md:ml-[8rem] mt-9 text-white text-3xl font-bold pl-9 md:pr-32'>My Skills</h2>
