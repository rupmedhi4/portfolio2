            ...
            <div className='flex flex-center mt-[3rem] flex-wrap md:justify-evenly  '>
                ...
                <div >
                    ...
                    <motion.div
                        ...
                        <a  href='https://drive.google.com/file/d/1S9KMRn0uo5sCQwqZDgJHn0WsQEwF5-vx/view?usp=sharing' target='_blank' className='bg-blue-700 rounded-full text-white  p-4 md:pl-16 md:pr-16 pr-20 pl-20 mb-4 font-bold text-center ml-4'>Download CV</a>
                    </motion.div>
                </div>
            </div>
        </>
