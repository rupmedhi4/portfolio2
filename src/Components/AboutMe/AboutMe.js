      ...
      <div className='flex md:justify-between justify-center flex-wrap md:p-5 md:pl-14'>
        ...
        <motion.div
          ...
          <div className='text-center pt-5'>
            <a  href='https://drive.google.com/file/d/1S9KMRn0uo5sCQwqZDgJHn0WsQEwF5-vx/view?usp=sharing' target='_blank' className='bg-blue-700 rounded-full text-white mb-4 p-4 pl-8 pr-8 font-bold'>Download CV</a>
          </div>
        </motion.div>
      </div>
    </div>
